...
class TestSanitizeString:
    ...
    def test_sanitize_xss_img_onerror(self):
    ...
    def test_sanitize_sql_patterns(self):
...
class TestValidateFilterStructure:
    """Tests for validate_filter_structure function."""
    ...
    def test_validate_with_booleans(self):
    ...
    def test_validate_non_string_keys(self):
    ...
    def test_validate_non_array_values(self):
    ...
    def test_validate_non_primitive_array_elements(self):
...
class TestSanitizeFilter:
    ...
    def test_sanitize_filter_with_xss_in_key(self):
    ...
    def test_sanitize_invalid_structure_raises(self):
    ...
    def test_sanitize_unicode_values(self):
